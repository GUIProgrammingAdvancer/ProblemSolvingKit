...
void MainMenu::revive(int appID){
    ...
    case 1:
        ...
        break;
    case 2:
        disconnect(this->myCalculator, SIGNAL(suicided(int)), this, SLOT(revive(int)));
        delete myCalculator;
        break;
    case 3:
        disconnect(this->myLottery, SIGNAL(suicided(int)), this, SLOT(revive(int)));
        delete myLottery;
        break;
    case 4:
        disconnect(this->myMeme, SIGNAL(suicided(int)), this, SLOT(revive(int)));
        delete myMeme;
        break;
    default:
        break;
